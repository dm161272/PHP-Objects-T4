...
<h2>Area calculator</h2>
    ...
    <form action ="" method ="POST" style="display: table;">
        ...
        <input type="radio" id="rect" name="shape" value="rect" checked><br />

        <label for="tri">Triangle</label>
        <input type="radio" id="tri" name="shape" value="tri"><br />

        <label>Enter height:</label> <input type="number" name="ht" value="0" ><br />

        <label>Enter width: </label> <input type="number" name="wh" value="0"><br />
